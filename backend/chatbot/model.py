...
class DisasterChatbot:
    ...
    def search_web(self, query: str) -> str:
        ...
        try:
            ...
            api_key = "e07f47762b7619935d3430ec0f773293594d492e6bee123b6267bc13f88d7dde"

            api_key = os.getenv("SERPAPI_KEY") # <<<<<<<< THIS IS THE IMPORTANT LINE
            ...
            return "No relevant search results found for disaster assessment."
        except Exception as e:
    ...
    def generate_response(self, user_message: str, use_web_search: bool = False) -> str:
        ...
        try:
            ...
            # Add web search results if enabled and confidence is low
            if use_web_search and (confidence < 0.8 or len(self.conversation_history) % 3 == 0):
